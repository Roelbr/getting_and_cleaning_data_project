...
## Downloading and processing is in current working directory. Create a new directory if you wish.
...
# Remove parentheses of test and train data
names(data) <- gsub('\\(|\\)',"",names(data), perl = TRUE)

# Make syntactically valid names of test and train data
names(data) <- make.names(names(data))

# Make clearer names of test and train data
